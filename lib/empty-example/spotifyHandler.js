class SpotifyHandler {
    ...
    //For development use:
    //static redirect = 'http://localhost:63342/trippy%20art/lib/empty-example/index.html?_ijt=evkd7fmeo0gfs3crtgqt78i4e9&_ij_reload=RELOAD_ON_SAVE';
    //For production use:
    static redirect = 'https://kieranparanjpe.github.io/Audio-Visualisers/';
    static profile = null;
    static accessToken;
    static details;
    static song;
